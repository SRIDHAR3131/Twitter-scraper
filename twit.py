...
# --- HIDE STREAMLIT STYLE --- from online source?
hide_st_style = """
            <style>
...
css = """
body {
  background-image: url('https://www.pexels.com/background-image.jpg');
  background-repeat: no-repeat;
  background-size: cover;
}
"""

# Use the `st.markdown` function to render the CSS code
